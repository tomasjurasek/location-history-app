<template>
    <div class="pa-3">
        ...
        <v-form>
            <v-file-input show-size counter label="Soubor" v-model="file"></v-file-input>
            <v-btn class="primary ma-2" v-on:click="submitFile()" :disabled="!file" :loading="loading">Nahrát</v-btn>
...
export default class Home extends Vue {
    ...
    submitFile() {
        ...
        axios.post( `${process.env.VUE_APP_API_URL}/users/${this.$route.params.id}/file`,
            formData,
            {
                headers: {
